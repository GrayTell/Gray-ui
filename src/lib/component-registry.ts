...
export const COMPONENTS: ComponentEntry[] = [
  ...
  ...(
    [
      ['halo', 'Halo', 'An open ring chasing its own tail. The every-project spinner.', HaloDemo, '<Halo />'],
      ['arc-sweep', 'Arc Sweep', 'A single bold arc riding a faint ring — the most compact way to say “working on it”.', ArcSweepDemo, '<ArcSweep />'],
      ['twin-arc', 'Twin Arc', 'Two opposite arcs sharing one orbit, reading as a single rotating gesture.', TwinArcDemo, '<TwinArc />'],
      ['fan-blade', 'Fan Blade', 'A quarter arc sweeping in circles like a blade catching the light.', FanBladeDemo, '<FanBlade />'],
      ['saturn', 'Saturn', 'A soft inner disc ringed by a faster arc circling just outside it.', SaturnDemo, '<Saturn />'],
      ['echo-ring', 'Echo Ring', 'A faint outer ring with a brighter inner arc answering it from inside.', EchoRingDemo, '<EchoRing />'],
      ['orbit-dot', 'Orbit Dot', 'A solid satellite riding the rim of a quiet ring.', OrbitDotDemo, '<OrbitDot />'],
      ['clockwork', 'Clockwork', 'A dial with one hand sweeping the face. Reads instantly as time passing.', ClockworkDemo, '<Clockwork />'],
      ['tick-ring', 'Tick Ring', 'Twelve ticks lighting up around the dial, one after another. The classic OS spinner.', TickRingDemo, '<TickRing />'],
      ['turbine', 'Turbine', 'Eight blades around an empty hub, spinning like a fan.', TurbineDemo, '<Turbine />'],
      ['dash-orbit', 'Dash Orbit', 'A dashed ring that breathes while it turns — pure CSS, no script.', DashOrbitDemo, '<DashOrbit />'],
      ['dash-bloom', 'Dash Bloom', 'A stroke that stretches around the circle and shrinks again while turning.', DashBloomDemo, '<DashBloom />'],
      ['gradient-arc', 'Gradient Arc', 'An arc whose tail melts into nothing as the head leads the rotation.', GradientArcDemo, '<GradientArc />'],
      ['shooting-star', 'Shooting Star', 'A bright head with a fading trail lapping a circular orbit.', ShootingStarDemo, '<ShootingStar />'],
      ['lemniscate', 'Lemniscate', 'A spark running laps around a figure-eight, forever.', LemniscateDemo, '<Lemniscate />'],
      ['figure-eight', 'Figure Eight', 'A loop retying itself between a circle and an infinity sign, drawn with native SVG morphing.', FigureEightDemo, '<FigureEight />'],
      ['pixel-diamond', 'Pixel Diamond', 'Eight square facets lighting up in sequence around a diamond.', PixelDiamondDemo, '<PixelDiamond />'],
      ['blink-dots', 'Blink Dots', 'Dots taking turns to light up. The smallest useful progress signal.', BlinkDotsDemo, '<BlinkDots />'],
      ['float-dots', 'Float Dots', 'Dots drifting up and down in a gentle relay. Calm enough for empty states.', FloatDotsDemo, '<FloatDots />'],
      ['jump-dots', 'Jump Dots', 'Dots swelling and dimming in a rolling wave. Friendly and compact.', JumpDotsDemo, '<JumpDots />'],
      ['breathe-dots', 'Breathe Dots', 'Dots inflating to half again their size before settling back.', BreatheDotsDemo, '<BreatheDots />'],
      ['chat-typing', 'Chat Typing', 'The familiar someone-is-typing bounce for message threads.', ChatTypingDemo, '<ChatTyping />'],
      ['heartbeat', 'Heartbeat', 'One dot breathing — scale up, settle, repeat. Made for single-point status.', HeartbeatDemo, '<Heartbeat />'],
      ['soft-pulse', 'Soft Pulse', 'An outlined circle inhaling and exhaling, dimming as it swells.', SoftPulseDemo, '<SoftPulse />'],
      ['sonar', 'Sonar', 'Rings radiating outward and dissolving, two beats out of phase.', SonarDemo, '<Sonar />'],
      ['dot-halo', 'Dot Halo', 'A crown of dots around an empty centre, brightening in turn.', DotHaloDemo, '<DotHalo />'],
      ['vortex', 'Vortex', 'Dots swirling on an invisible ring, blooming in and out of existence.', VortexDemo, '<Vortex />'],
      ['trio-orbit', 'Trio Orbit', 'Three dots locked on a spinning rod, sweeping like a propeller.', TrioOrbitDemo, '<TrioOrbit />'],
      ['binary-orbit', 'Binary Orbit', 'A calm nucleus with two moons circling on opposite sides of the same track.', BinaryOrbitDemo, '<BinaryOrbit />'],
      ['pulse-bars', 'Pulse Bars', 'Slim bars contracting and brightening in sequence. Scales with text size.', PulseBarsDemo, '<PulseBars />'],
      ['sound-wave', 'Sound Wave', 'Five rounded bars swaying in sequence — the voice-active silhouette.', SoundWaveDemo, '<SoundWave />'],
      ['scaffold', 'Scaffold', 'A breathing placeholder block for sketching loading layouts.', ScaffoldDemo, '<Scaffold className="h-10 w-40" />'],
      ['frame-scan', 'Frame Scan', 'An image frame with a scanner beam sweeping across a faint landscape.', FrameScanDemo, '<FrameScan />'],
      ['googly-eyes', 'Googly Eyes', 'Two eyes whose pupils wander around and occasionally blink.', GooglyEyesDemo, '<GooglyEyes />'],
      ['block-slide', 'Block Slide', 'Shaded ASCII cells gliding back and forth along a dim track.', BlockSlideDemo, '<BlockSlide />'],
      ['block-march', 'Block March', 'Shaded cells marching across a dim ASCII track, looping at the far edge.', BlockMarchDemo, '<BlockMarch />'],
      ['pixel-patrol', 'Pixel Patrol', 'A train of shaded cells pacing the perimeter of an invisible rectangle.', PixelPatrolDemo, '<PixelPatrol />'],
      ['block-track', 'Block Track', 'The paced patrol with its rectangle drawn as a dim ASCII rail.', BlockTrackDemo, '<BlockTrack />'],
      ['block-corners', 'Block Corners', 'A block touring a drawn grid and pausing at every corner.', BlockCornersDemo, '<BlockCorners />'],
      ['block-orbit', 'Block Orbit', 'A bright cell circling the rim of a drawn grid without stopping.', BlockOrbitDemo, '<BlockOrbit />'],
      ['block-snake', 'Block Snake', 'Shaded cells chasing each other around an invisible square.', BlockSnakeDemo, '<BlockSnake />'],
      ['tide', 'Tide', 'Brightness rolling outward from the centre of a row of cells and back.', TideDemo, '<Tide />'],
      ['prompt-caret', 'Prompt Caret', 'A shell prompt with a hard-blinking block cursor.', PromptCaretDemo, '<PromptCaret />'],
      ['fade-text', 'Fade Text', 'A line of text drifting in and out of focus.', FadeTextDemo, '<FadeText>Loading content</FadeText>'],
      ['ellipsis', 'Ellipsis', 'Your message followed by dots appearing one at a time.', EllipsisDemo, '<Ellipsis>Fetching results</Ellipsis>'],
      ['shimmer-wave', 'Shimmer Wave', 'Brightness rippling through the text character by character.', ShimmerWaveDemo, '<ShimmerWave>Generating response</ShimmerWave>'],
      ['gloss-sweep', 'Gloss Sweep', 'A band of full brightness sliding across otherwise muted text.', GlossSweepDemo, '<GlossSweep>Polishing details</GlossSweep>'],
    ] as Array<[string, string, string, ComponentType, string]>
  ).map(([slug, name, description, Demo, usage]): ComponentEntry => ({
    slug,
    name,
    category: 'Loaders',
    description,
    Demo,
    code: `import { ${name.replace(/\s+/g, '')} } from "@/components/gray/${slug}"\n\nexport function Demo() {\n  return ${usage}\n}`,
  })),
