...
import { ComponentsLayout } from '@/components/site/components-docs'
            ...
            <div className="mx-auto flex w-full max-w-160 min-w-0 flex-1 flex-col gap-6 px-4 py-6 text-foreground md:px-0 lg:py-8 dark:text-foreground">
              ...
              <div className="w-full flex-1 pb-16 sm:pb-0">
                ...
                <p className="mt-2 text-sm text-muted-foreground">
                  Live, interactive demo — click, type and toggle. It&apos;s the real
                ...
                <p className="mt-2 mb-4 text-sm text-muted-foreground">
                  Install {entry.name} from the Gray registry with one command.
                </p>
